...
import com.leaves.entity.Menu;
import com.leaves.entity.Permission;
import com.leaves.entity.SubSystemInfo;
import com.leaves.mapper.PermissionMapper;
import com.leaves.mapper.RoleMapper;
import com.leaves.service.PermissionService;
...
public class PermissionServiceImpl implements PermissionService {
    ...
    public boolean allotPermission(String ids, String roleId) {
        ...
        if (i > 0) {
            for (String s : idList) {
                if (IntegrateUtils.stringIsNotBlack(s)) {
