...
import com.leaves.entity.Attention;
...
public interface UserService {
    ...
    Page<User> getUserListOrderByPostNum(User user, int page, int limit);
     ...
     * @return
     */
    boolean insertAttention(String attenId);
     ...
     * @return
     */
    boolean delAttention(String attenId);

    /**
     * 判断当前用户是否关注了
     */
    boolean isAttention(String attenId);

    /**
     * 得到关注的集合
     */
    List<Attention> getAttentionList(String userId);
     ...
     * @return
     */
    List<Attention> getFenAttentionList(String attenId);
