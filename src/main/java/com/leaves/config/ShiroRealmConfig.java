...
public class ShiroRealmConfig extends AuthorizingRealm {
    private static final transient Logger log = LoggerFactory.getLogger(ShiroRealmConfig.class);
