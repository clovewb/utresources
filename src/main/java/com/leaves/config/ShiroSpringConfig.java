...
import com.leaves.util.CustomConfiguration;
...
public class ShiroSpringConfig {
    ...
    public ShiroFilterFactoryBean shirFilter(DefaultWebSecurityManager securityManager) {
        ...
        //普通用户登陆接口
        filterChainDefinitionMap.put("/loginNormal.do", "anon");
        //注册界面
        ...
        //前台关于我们接口
        filterChainDefinitionMap.put("/front/aboutWe.do", "anon");
        //前台新闻资讯列表接口s
        filterChainDefinitionMap.put("/front/news.do", "anon");
        filterChainDefinitionMap.put("/front/newDetail.do", "anon");
        //找回密码弹窗
        filterChainDefinitionMap.put("/retrieve.do", "anon");
        //找回密码结构
        filterChainDefinitionMap.put("/retrievePass.do", "anon");
    ...
    @Bean
    public ShiroRealmConfig itDragonShiroRealm() {
