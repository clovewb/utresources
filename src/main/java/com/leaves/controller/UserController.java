...
import com.leaves.service.RoleService;
...
public class UserController {
    ...
    public TableResultResponse userTables(User user, int page, int limit) {
        ...
        for (User userEntity : pageInfo.getRecords()) {
            ...
            userMap.put("blance", userEntity.getBlance());
            userMap.put("postNum", userEntity.getPostNum());
            userMap.put("userRank", userEntity.getUserRank());
